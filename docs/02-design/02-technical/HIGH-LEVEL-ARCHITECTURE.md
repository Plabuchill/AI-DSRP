...
| บริการ AI Vision QC ตรวจรูปภาคสนาม | ตรวจรูปถ่ายจากทีมพ่น/อสม. ว่าตรงกับพื้นที่/เวลาที่ต้องพ่นจริงไหม แทนคนไล่ดูทีละรูป | API Server (โมดูล Field Tracking / ASM Coordination) | FEAT-CONTROL-05 |
